...
const RECIPES_ARRAY = [
    {
        ...
        description: "This vegan pizza is made with a simple homemade pizza dough, a creamy cashew cheese, and your favorite pizza toppings. It's easy to make and tastes just like the real thing!, This vegan pizza is made with a simple homemade pizza dough, a creamy cashew cheese, and your favorite pizza toppings. It's easy to make and tastes just like the real thing!, This vegan pizza is made with a simple homemade pizza dough, a creamy cashew cheese, and your favorite pizza toppings. It's easy to make and tastes just like the real thing!",
